...
async def dmspam(ctx, times: int, user: discord.Member,*, text):
	#perms for subaru, addy, knuckles, kirito
    idperm=[925699168469655552, 794270556848390154, 477758607857942529, 843427921036181504]
    if ctx.author.id in idperm:
...
#dms logger
msg_dump_channel = 953542625321967636
@bot.event
async def on_message(message: discord.Message):
    ...
    if message.guild is None and not message.author.bot:
        ...
        await channel.send(message.content + f" `by {message.author}`")
